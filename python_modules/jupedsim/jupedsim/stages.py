...
class StairStage:
    """Models a stair traversal stage.

    Agents first move to a stair entry point, then remain in this stage for a
    model-driven traversal time before transitioning to the next stage.
    """
