...
class Simulation:
    ...
    def add_stair_stage(
        ...
        *,
        ...
        """Add a stair traversal stage to the simulation.
        ...
        Arguments:
            position: Entry point of the stair.
            length: Effective walking length of the stair in meters.
            distance: Radius around `position` considered as reached.
            speed_factor: Multiplier applied to each agent's desired speed.
            waiting_time: Additional fixed delay in seconds.
            time_step: Time step used by the stage for the internal timer.

        Returns:
            Id of the added stair stage.
        """
        return self._obj.add_stair_stage(
            position=position,
            distance=distance,
            length=length,
